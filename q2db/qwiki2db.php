...
foreach ($text as $line)
{
	...
	echo $line;
	if(!strcmp(substr($line, 1,1), "#")) { //if the second character is # ie id ##
		...
		$mysqli->query($anssql) or die("dead inserting answers");		
		...
		$mysqli->query($sql) or die("dead inserting questions"); 
